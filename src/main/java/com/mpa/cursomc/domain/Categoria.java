...
public class Categoria extends AbstractEntity<Integer> {
	...
	/* Quando se tem relacionamentos bidirecionais, pode ocorrer o problema de referência cíclica, quando vc busca uma categoria, a busca
       ...
       Obs.: Segundo o professor, o uso dessas anotações apresentou problemas, uma solução é onde estiver JsonManagedReference, simplesmente
             apagar, e, onde tiver JsonBackReference, substituir por JsonIgnore.
